...
SOURCEFILES_QUOTED_IF_SPACED=LEDBlink1test.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/LEDBlink1test.o
POSSIBLE_DEPFILES=${OBJECTDIR}/LEDBlink1test.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/LEDBlink1test.o

# Source Files
SOURCEFILES=LEDBlink1test.asm
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/LEDBlink.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/LEDBlink1test.o: LEDBlink1test.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/LEDBlink1test.o 
	${MP_AS} -mcpu=PIC18F4550 -c \
	-o ${OBJECTDIR}/LEDBlink1test.o \
	LEDBlink1test.asm \
...
${DISTDIR}/LEDBlink.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/LEDBlink.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
