# 1 "LedBlinkPlusTest.asm"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 296 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "LedBlinkPlusTest.asm" 2
;=====================================================
; 5 parpadeos de 1s
...
;--------------------------------
; Configurar ((PORTB) and 0FFh), 0, a como salida
;--------------------------------
    BCF TRISB,0,A ; ((PORTB) and 0FFh), 0, a salida
